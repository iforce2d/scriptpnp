...
public:
	...
	struct LanguageDefinition
	{
        ...
        static const LanguageDefinition& PNPCommand();
	};
    ...
    int GetTextLines(std::vector<std::string> & result) const;
    ...
    void ClearTextChangedStatus() { mTextChanged = false; }
