...
bool runScript(std::string moduleName, std::string funcName, bool previewOnly, void* codeEditorWindow = NULL);

bool compileScript(std::string moduleName, std::string funcName, compiledScript_t &compiled, void* codeEditorWindow = NULL);
